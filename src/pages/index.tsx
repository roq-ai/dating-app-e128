  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Dating App - Connect, Communicate, and Create meaningful relationships. Discover new people, engage in written conversations, and share your moments just like Instagram."
        />
      </Head>
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1517245386807-bb43f82c33c4?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxjb21tdW5pY2F0aW9ufGVufDB8fHx8MTY4OTk0NjQ2N3ww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Dating App - Connect, Communicate, and Create meaningful relationships. Discover new people, engage in written conversations, and share your moments just like Instagram.`}
            </Text>
            <Box
